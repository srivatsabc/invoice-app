...
import { LineChart, BarChart3, Clock, Zap, Settings } from 'lucide-react';
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-slate-200 mt-1">Monitor system performance and processing analytics</p>
            </div>
          </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 min-h-[500px] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-slate-500 text-lg mb-6 max-w-md mx-auto">
            Comprehensive performance analytics and metrics dashboard is under development to help you optimize your invoice processing workflows.
          </p>
