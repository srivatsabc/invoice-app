...
import { Download, FileText, Clock, Zap, Settings } from 'lucide-react';
      ...
      <div className="bg-gradient-to-r from-slate-500 via-slate-600 to-slate-700 rounded-xl p-6 mb-8 text-white">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-3xl font-bold">Export for Analysis</h1>
              <p className="text-slate-200 mt-1">Export invoice data and reports for external analysis and reporting</p>
            </div>
          </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 min-h-[500px] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-slate-500 text-lg mb-6 max-w-md mx-auto">
            Advanced export functionality with support for multiple formats including CSV, Excel, PDF reports, and API integrations for seamless data analysis.
          </p>
...
export default ExportForAnalysis;